...
const SAMPLES = {
  ...
  'yida-schema-render': {
    'data-list': 'data-list.schema.json',
    'detail-card': 'detail-card.schema.json',
    'form-panel': 'form-panel.schema.json',
    'stat-board': 'stat-board.schema.json',
    'action-bar': 'action-bar.schema.json',
  },
  'yida-density': {

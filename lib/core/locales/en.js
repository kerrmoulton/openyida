...
module.exports = {
  ...
  help: {
    ...
    cmd_safety_status: 'Show OpenYida safety mode and config sources',
    cmd_safety_mode: 'Configure global or project safety mode',
    cmd_apply_plan: 'Apply a reviewed OpenYida plan from a non-agent terminal',

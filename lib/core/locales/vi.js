...
module.exports = {
  ...
  publish: {
    ...
    lint_native_select_ui: 'Found a native <select>. Custom page dropdowns should use the Yida SelectField component (this.$(fieldId) or <SelectField>), or a div+button+onClick custom dropdown, for consistent styling and mobile compatibility',

...
const COMMAND_GROUPS = [
  ...
  },
  {
    ...
    commands: [
      ...
      command('schema-render.generate', ['schema-render', 'generate'], 'schema-render generate <appType> <formUuid> [--type DataList|DetailCard|FormPanel|StatBoard|ActionBar] [--schema file] [--output path]', 'help.cmd_schema_render', {
        requiresLogin: false,
      }),
      command('schema-render.preview', ['schema-render', 'preview'], 'schema-render preview <schemaFile> [--output html]', 'help.cmd_schema_render_preview', {
        requiresLogin: false,
      }),

...
const COMMAND_GROUPS = [
  ...
  },
  {
    ...
    commands: [
      ...
      command('create-form.patch', ['create-form', 'patch'], 'create-form patch <appType> <formUuid> <patchJsonOrFile> [--compile-native-styles|--no-compile-native-styles] [--open|--no-open]', 'help.cmd_update_form'),
  ...
  },
  {
    ...
    commands: [
      ...
      command('safety.status', ['safety', 'status'], 'safety status [--json]', 'help.cmd_safety_status', {
        requiresLogin: false,
        output: 'text|json',
      }),
      command('safety.mode', ['safety'], 'safety <global|project> mode <readonly|plan|full> [--json]', 'help.cmd_safety_mode', {
        requiresLogin: false,
        output: 'text|json',
      }),
      command('apply-plan', ['apply-plan'], 'apply-plan <plan-file> [--json]', 'help.cmd_apply_plan', {
        output: 'text|json',
      }),
